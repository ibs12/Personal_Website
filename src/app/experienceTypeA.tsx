            ...
            {/*Extern Experience*/}
                    <div className="grid grid-cols-1 grid-rows-1 gap-4">
                            <div className="row-span-1">
                                    <div className= "flex flex-row ">
                                        ...
                                        <div className = "flex-col content-center">
                                            <h2 className = "Helvetica  text-3xl font-semibold tracking-wide text-white ml-5">Beats by Dre Consumer Insights Data Analytics Extern</h2>
                        ...
                        <div className="grid grid-cols-10 grid-rows-1">
                            <div className="row-span-1 col-start-2 col-span-8">
                                <div className= "flex justify-center items-center gap-32">
                                    <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-pretty text-gray-400 ">
                                    <>
                                   ...
                                   consumer reviews</span>.
                                    ...
                                    <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-gray-400 ">
                                    <>
                            ...
                            <div className="grid grid-cols-10 grid-rows-2">
                                <div className="row-span-1 col-start-2 col-span-8">
                                    <div className= "flex justify-center items-center gap-32">
                                        ...
                                        <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-gray-400 ml-5 mt-7">
                                        <>
                                        ...
                                        <h2 className = " Helvetica text-2xl font-semibold tracking-wide text-pretty text-gray-400 ml-5 mt-7">
                                        <>
                                ...
                                <div className="row-span-1 col-start-4 col-span-4">
                                        <div className= "flex justify-center items-center gap-32">
                                            <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-gray-400 ml-5 mt-7">
                                            Utilized <span style={{ color: "white" }}>advanced natural language processing </span> tools to interpret and summarize customer feedback.
                                            </h2>
                    ...
                    <div className="grid grid-cols-1 grid-rows-1 gap-4">
                        ...
                        <div className="grid grid-cols-7 grid-rows-1">
                            <div className="row-span-1 col-start-2 col-span-5">
                                <div className= "flex justify-center items-center gap-32">
                                    <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-pretty text-gray-400 ml-5 mt-7">
                                    <>
                                    ...
                                    <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-pretty text-gray-400 ml-5 mt-7">
                                    Expanded knowledge in computer vision and machine learning to enhance understanding of how labels are used by
                                    learning algorithms, was able to design a <span style={{ color: "white" }}>98% accurate machine learning model</span>
                                    </h2>
                                    <h2 className = "Helvetica text-2xl font-semibold tracking-wide text-gray-400 ml-5 mt-7">
                                    Utilized <span style={{ color: "white" }}>advanced natural language processing </span> tools to interpret and summarize customer feedback.
                                    </h2>
